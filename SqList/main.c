...
void interact(void)
{
    ...
    sqList **L = (sqList **)malloc(sizeof(sqList *) * MAXN);
    memset(L, 0, sizeof(sqList *) * MAXN);
    ...
    while ((scanf("%d", &choose) == 1) && choose != 0)
    {
        ...
        case 4:
            switch (ListEmpty(L[numL]))
            {
                ERROR_CASE;
            case TRUE:
                fprintf(stdout, "sqList is empty!\n");
                break;
            case FALSE:
                fprintf(stdout, "sqList is not empty!\n");
                break;
            }
            break;
        case 5:
            ...
            if (ret == ERROR)
                ...
                fprintf(stdout, "sqList length is %d.\n", ret);
            break;
        case 6:
        ...
        case 14:
            ...
            break;
        case 15:
            fprintf(stdout, "Enter the NewList Number[0~%d]:", MAXN - 1);
        ...
        case 16:
            ++MAXN;
            L = (sqList **)realloc(L, sizeof(sqList *) * MAXN);
            L[MAXN - 1] = (sqList *)malloc(sizeof(sqList));
            if (L == NULL)
            {
